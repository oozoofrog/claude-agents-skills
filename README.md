...
| `tdd-tiny-refactoring-principles` | TDD/작은 리팩토링 원칙(켄트 벡, 마틴 파울러에게서 영감) + 코드 스멜 진단/체크리스트 |
...
- Skill: `skills/tdd-tiny-refactoring-principles/SKILL.md` (상세 문서: `PRINCIPLES.md`, `CHECKLIST.md`, `SMELLS.md`)
